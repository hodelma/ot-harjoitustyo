...
class TestGame(unittest.TestCase):
    ...
    def test_collect_coin_accumulates_different_values(self):
        self.game.collect_coin(1)
        self.game.collect_coin(2)
    ...
    def test_start_with_three_lives(self):
        self.assertEqual(self.game.lives, 3)

    def test_hit_monster_reduces_lives(self):
        self.game.hit_monster()
    ...
    def test_hit_monster_three_times_sets_game_over(self):
        self.game.hit_monster()
        self.game.hit_monster()
        self.game.hit_monster()
